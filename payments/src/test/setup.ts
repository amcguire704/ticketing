...
process.env.STRIPE_KEY = 'sk_test_ItJ4KXVSXTf76rc5yNAaHbDj00msGZc5p1';
//we have to define the stripe key because it willbe used the instant we require in
//the stripe library if its not defined it will break
